...
def save_agent(agent, filename="agents/sac_agent_tm20full.pth"):
    torch.save(
        {
...
def save_replay_buffer(replay_buffer, filename="agents/sac_replay_buffer_tm20full.pkl"):
...
def load_agent(agent, filename="agents/sac_agent_tm20full.pth"):
...
def load_replay_buffer(replay_buffer, filename="agents/sac_replay_buffer_tm20full.pkl"):
...
agent_checkpoint_file = "agents/sac_agent_tm20full.pth"
replay_buffer_file = "agents/sac_replay_buffer_tm20full.pkl"
...
for step in range(10000000):  # Total number of training steps v
